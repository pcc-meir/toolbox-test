...
const toolboxTranslationRef = createTranslationRef({
  id: "toolbox",
  messages: {
    toolsPage: {
      title: "Toolbox",
    ...
    tool: {
      ...
      "jwt-decoder-encode": {
        ...
        missingAttribute: "Couldn't encode JWT token: missing attribute {{attribute}}"
      },
      "markdown-preview": {
...
const toolboxTranslations = createTranslationResource({
  ref: toolboxTranslationRef,
  translations: {
    fi: () => import('./locales/fi.esm.js')
  }
});

export { toolboxTranslationRef, toolboxTranslations };
